...
import { FileText, List, Loader2, AlertCircle, CheckCircle2, User, MapPin, Hash, MessageSquare } from 'lucide-react'
...
export default function ContentsInvTool() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (canViewMaster) loadSubmissions()
    } catch (e: any) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 min-h-[100dvh]">
      <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 pb-6">
        ...
        {canViewMaster && (
          <div className="grid grid-cols-2 gap-2 sm:flex sm:gap-2 mb-4 sm:mb-6">
            <button
              type="button"
            ...
            >
              ...
              <span className="truncate hidden sm:inline">View all submissions</span>
        ...
        {view === 'list' && canViewMaster && (
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            <div className="p-4 border-b border-gray-200 dark:border-gray-800">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">All submissions</h2>
            </div>
            {loadingSubmissions ? (
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between flex-shrink-0 z-10">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Submission details</h3>
                <button
                  type="button"
                  onClick={() => { setSelectedId(null); setSelectedSubmission(null) }}
                  ...
                  <div className="space-y-4 pb-8">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="font-medium text-gray-900 dark:text-white break-words">{selectedSubmission.clientName}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-gray-900 dark:text-white break-words">{selectedSubmission.address}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Hash className="w-5 h-5 text-gray-500 mt-0.5 flex-shrink-0" />
                      <div className="min-w-0">
                        <p className="text-xs text-gray-500 dark:text-gray-400">Customer job code</p>
                        <p className="text-gray-900 dark:text-white break-words">{selectedSubmission.customerJobCode}</p>
                      </div>
                    </div>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Submitted by {selectedSubmission.user?.name || selectedSubmission.user?.email} on{' '}
                      {format(new Date(selectedSubmission.createdAt), 'MMM d, yyyy HH:mm')}
                    </p>
                    <div className="border-t border-gray-200 dark:border-gray-800 pt-4 mt-4">
                      <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase mb-2">Answers</p>
                      <pre className="text-sm text-gray-800 dark:text-gray-200 bg-gray-50 dark:bg-gray-800 p-4 rounded-xl overflow-x-auto max-w-full">
